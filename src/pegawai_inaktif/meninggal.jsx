      ...
      <div className="overflow-x-auto">
        ...
        <table className="w-full border border-teal-600 rounded-lg overflow-hidden my-5">
          ...
          <tr className="bg-teal-900 text-white">
              ...
              <th rowSpan="2" className="p-3 border border-teal-500 text-left font-bold uppercase text-sm">Keterangan Meninggal</th>
          ...
          <tbody>
            ...
            {pegawai.map((data, index) => (
              ...
              >
                ...
                <td className="p-3 border border-teal-500 text-left font-bold uppercase text-sm">{data.keterangan}</td>
                <td className="p-3 border border-teal-500 text-left font-bold uppercase text-sm">
  {/* Icon View */}
