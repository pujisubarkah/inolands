      ...
      <main className="flex flex-col items-center text-center py-12 px-4" style={{ backgroundColor: '#8B0000' }}>
        <div className="flex items-center justify-center bg-darkred text-white py-12 px-6 rounded-lg" style={{ margin: '20px', padding: '20px' }}>
          ...
          <div className="text-left w-3/5">
            ...
            <section className="text-blue-900 py-6">
              <div className="container mx-auto flex justify-around space-x-2">
                <div className="text-center p-4 bg-gray-100 rounded-lg shadow-md">
                  ...
                  <div className="text-2xl font-bold py-2">12.392</div>
                </div>
                <div className="text-center p-4 bg-gray-100 rounded-lg shadow-md">
                  <div className="bg-green-600 text-white text-lg font-bold py-2 px-4 rounded">FASILITASI OPD</div>
                  <div className="text-2xl font-bold py-2">119</div>
                </div>
                <div className="text-center p-4 bg-gray-100 rounded-lg shadow-md">
